...
contract ConstantinopleTests is DSTest {
    ...
    // 60     00     60     00     f3
    bytes32 zerocode =
        0x60006000f3000000000000000000000000000000000000000000000000000000;
    ...
    bytes32 deadcode =
        0x63deadbeef60005260206000f300000000000000000000000000000000000000;
    ...
    bytes32 deploysdeadcode =
        0x600d600c600039600d6000f363deadbeef60005260206000f300000000000000;
    ...
    function test_create2_2() public {
        ...
        assertEq(DeadCode(a).getZero(), 0xdeadbeef);
    }
