...
export class SmartContractManager
{
    ...
    }>
    {
        ...
        try {
            ...
            return {
                name: iface.decodeFunctionResult('name', nameResult as string)[0] as string,
                symbol: iface.decodeFunctionResult('symbol', symbolResult as string)[0] as string,
                decimals: iface.decodeFunctionResult('decimals', decimalsResult as string)[0] as number,
                totalSupply: iface.decodeFunctionResult('totalSupply', totalSupplyResult as string)[0] as string
            }
        } catch (error) {
            throw new Error(
